/**
 * @license AngularJS v1.2.13-build.local+sha.45dc231
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.13-build.local+sha.45dc231/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.13-build.local+sha.45dc231',    // all of these placeholder strings will be replaced by grunt's
