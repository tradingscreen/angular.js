/**
 * @license AngularJS v1.2.29-local+sha.d202a1d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.29-local+sha.d202a1d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.29-local+sha.d202a1d',    // all of these placeholder strings will be replaced by grunt's
